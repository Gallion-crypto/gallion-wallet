...
// Copyright (c) 2016-2018 The Gallion developers
...
void MainWindow::initUi() {
  setWindowTitle(QString(tr("Gallion Wallet %1")).arg(Settings::instance().getVersion()));
#ifdef Q_OS_WIN32
  createTrayIcon();
#endif
...
//  QMessageBox::information(nullptr, QObject::tr("Help"), cmdLineParser.getHelpText());
    QMessageBox *msg = new QMessageBox(QMessageBox::Information, QObject::tr("Help"),
                       ...
                       QMessageBox::Ok, this);
    msg->setInformativeText(tr("More info can be found at www.gallion.com in Documentation section"));
...
void MainWindow::createTrayIcon()
{
    ...
    QString toolTip = QString(tr("Gallion Wallet %1")).arg(Settings::instance().getVersion());
